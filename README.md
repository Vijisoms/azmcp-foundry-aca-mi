...
```
CONTAINER_APP_URL="https://fabric-mcp-myserver.wonderfulname-a1b2c3d4.eastus.azurecontainerapps.io"
ENTRA_APP_CLIENT_ID="00001111-aaaa-2222-bbbb-3333cccc4444"
ENTRA_APP_IDENTIFIER_URI="api://00001111-aaaa-2222-bbbb-3333cccc4444"
ENTRA_APP_OBJECT_ID="aaaabbbb-1111-2222-3333-ccccdddd4444"
ENTRA_APP_ROLE_ID="11112222-aaaa-bbbb-cccc-333344445555"
ENTRA_APP_SERVICE_PRINCIPAL_ID="55556666-aaaa-bbbb-cccc-777788889999"
```
...
2. In VS Code, open MCP server settings and add a new server with:
   - **URL**: Your `CONTAINER_APP_URL` (e.g., `https://fabric-mcp-myserver.wonderfulname-a1b2c3d4.eastus.azurecontainerapps.io/`)
